...
export default function CallToAction() {
  return (
    <Box bg="#2EC5CE" color={useColorModeValue("white", "black")} py="10">
      {/* <Flex width="100%">
        <Stack
          direction={{
            sm: "column",
	  ...
	  <Box bg={useColorModeValue('white', 'black')}>
	  	...
	  	<chakra.h1>Get Started</chakra.h1>
		  </Stack>
	  </Box>
    </Box>
  );
  ...
  return (
    ...
    >
      ...
      <g filter="url(#filter3_d)">
        <rect x="20" y="15" width="232" height="464" fill="url(#pattern0)" />
      </g>
      <defs>
        <filter
          id="filter0_dii"
        ...
        <pattern
          ...
          height="1"
        >
          <use href="#image0" transform="scale(0.00208333 0.00104167)" />
        </pattern>
        <linearGradient
          id="paint0_linear"
          x1="136"
